...
def main():
    ...
    q1 = int(input('Escolha um Marketplace\n\n[1] Mercado Livre\n[2] Shopee\n> '))
    if q1 == 1:
        taxa_marketplace = 11
        taxa_marketplace = taxa_marketplace / 100.0
        q2 = int(input('Comissão do Mercado Livre = {:.0f}. O valor está correto?\n'
        ...
        if q2 == 2:
            ...
            taxa_marketplace = taxa_marketplace / 100.0
            print('Comissão alterada para = {:.0f}'.format(taxa_marketplace * 100))
