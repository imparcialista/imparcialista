  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-3/4 right-1/4 w-1 h-1 bg-accent-secondary rounded-full opacity-30 animate-float" style={{animationDelay: '1s'}}></div>
        <div className="absolute top-1/2 left-1/2 w-3 h-3 bg-blue-500 rounded-full opacity-20 animate-float" style={{animationDelay: '2s'}}></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in-left glass p-8 rounded-2xl">
            ...
            <p className="text-lg sm:text-xl text-gray-300 leading-relaxed">
              ...
              <br /><br />
              Por atuar na área, vi que tem muitos pontos de melhorias disponíveis, 
              e eu estou disposto a mudar o jogo. Se você ficou interessado, 
              não hesite em me procurar, aguardo seu contato.
            </p>
            ...
            <div className="pt-4">
              <Link
                to="/portfolio"
                className="inline-block bg-accent text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-accent-hover transition-all duration-300 transform hover:scale-105 shadow-lg hover-lift animate-pulse-slow"
              >
